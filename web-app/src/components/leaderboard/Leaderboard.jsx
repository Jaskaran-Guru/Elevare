...
import { LogOut, BookOpen, Target, Award, TrendingUp, Trophy, Star } from 'lucide-react';
...
const Dashboard = () => {
  ...
  // ✅ MOVED HANDLER FUNCTIONS INSIDE COMPONENT
  ...
  const handleQuizComplete = (results) => {
    ...
    toast.success(
      `Quiz completed! Score: ${results.score}/${results.total} (${results.percentage}%)`,
      { duration: 5000 }
    );
  };
        ...
        >
          ...
          <div className="bg-white rounded-xl shadow-lg p-8 mb-8">
            ...
            <button
              ...
              className="inline-flex items-center bg-gradient-to-r from-purple-600 to-pink-600 text-white px-6 py-3 rounded-lg text-lg font-semibold hover:from-purple-700 hover:to-pink-700 transition-all duration-300 transform hover:scale-105 shadow-lg"
            >
